...
struct sr_packet {
    ...
    char *in_iface;             /* The incoming interface */
...
void  sr_arpcache_sweepreqs(struct sr_instance *sr);
int   send_arp_reply(struct sr_instance *sr, sr_ethernet_hdr_t *ether_hdr, uint8_t * packet, struct sr_if *sr_interface);
void  handle_arpreq(struct sr_arpreq *req, struct sr_instance *sr);
void  sr_handle_arp_reply(struct sr_instance *sr, uint8_t * packet);
int   send_arp_request(struct sr_arpreq *req, struct sr_instance *sr);
